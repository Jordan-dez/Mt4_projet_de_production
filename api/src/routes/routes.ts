...
const models: TsoaRoute.Models = {
    ...
    "Partial_IUser_": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"uuid":{"dataType":"string"},"email":{"dataType":"string"},"createdAt":{"dataType":"datetime"},"firstname":{"dataType":"string"},"lastname":{"dataType":"string"},"role":{"ref":"Roles"},"token":{"dataType":"string"},"updatedAt":{"dataType":"union","subSchemas":[{"dataType":"datetime"},{"dataType":"enum","enums":[null]}]}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Pick_IUserORM.Exclude_keyofIUserORM.-or-updated_at__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"uuid":{"dataType":"string","required":true},"email":{"dataType":"string","required":true},"firstname":{"dataType":"string"},"lastname":{"dataType":"string"},"role":{"ref":"Roles"},"token":{"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}]},"created_at":{"dataType":"datetime","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Omit_IUserORM.-or-updated_at_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_IUserORM.Exclude_keyofIUserORM.-or-updated_at__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IUserOrmCreate": {
        "dataType": "refAlias",
        "type": {"ref":"Omit_IUserORM.-or-updated_at_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Pick_IChallenge.name-or-description_": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"name":{"dataType":"string","required":true},"description":{"dataType":"string"}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Pick_IQuestions.Exclude_keyofIQuestions.id-or-challengeUuid-or-createdAt-or-updatedAt__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"question":{"dataType":"string","required":true},"expectedAnswer":{"dataType":"string","required":true},"command":{"dataType":"string"},"note":{"dataType":"double"}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Omit_IQuestions.id-or-challengeUuid-or-createdAt-or-updatedAt_": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_IQuestions.Exclude_keyofIQuestions.id-or-challengeUuid-or-createdAt-or-updatedAt__","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "IQuestionsCreate": {
        "dataType": "refAlias",
        "type": {"ref":"Omit_IQuestions.id-or-challengeUuid-or-createdAt-or-updatedAt_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/auth/magic-link-admin',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.sendAdminMagicLink)),

            function AuthController_sendAdminMagicLink(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/auth/magic-link-student',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.sendStudentMagicLink)),

            function AuthController_sendStudentMagicLink(request: any, response: any, next: any) {
            const args = {
                    email: {"in":"query","name":"email","required":true,"dataType":"string"},
                    challengeUuid: {"in":"query","name":"challengeUuid","required":true,"dataType":"string"},
                    challengeName: {"in":"query","name":"challengeName","required":true,"dataType":"string"},
            };
            ...
            try {
              ...
              const promise = controller.sendStudentMagicLink.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.put('/auth/user',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.createStudentProfile)),

            function AuthController_createStudentProfile(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"IUserOrmCreate"},
            };
            ...
            try {
              ...
              const promise = controller.createStudentProfile.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/protected/challenge',
            ...
            function ChallengeController_create(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"IChallengeRequestBody"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/protected/challenge/:uuid',
            authenticateMiddleware([{"jwt":["Admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(ChallengeController)),
            ...(fetchMiddlewares<RequestHandler>(ChallengeController.prototype.get)),

            function ChallengeController_get(request: any, response: any, next: any) {
            const args = {
